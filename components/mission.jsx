...
export default function Mission() {
  ...
  const values = [
    { num: "01", title: "Flexibilidad", desc: "Tu vida cambia, tu sistema también" },
    { num: "02", title: "Humanidad", desc: "No somos robots productivos" },
    { num: "03", title: "Claridad", desc: "Menos ruido, más enfoque" },
    { num: "04", title: "Sostenibilidad", desc: "Lo que no se puede sostener, no sirve" },
    { num: "05", title: "Respeto", desc: "El cuerpo no se fuerza, se escucha" },
  ]

  return (
    <section ref={sectionRef} id="mision" className="py-24 md:py-40 bg-muted relative overflow-hidden">
      <div className="w-[90%] md:w-[85%] max-w-7xl mx-auto">
        <div ref={titleRef} className="mb-24 md:mb-40">
        ...
        <div className="grid lg:grid-cols-12 gap-6 mb-32">
          ...
          >
            <span className="absolute top-6 right-6 text-8xl md:text-9xl font-sans font-light text-primary/10">M</span>
            <span className="text-sm tracking-[0.5em] uppercase text-secondary font-sans">Misión</span>
            <p className="mt-8 text-2xl md:text-3xl lg:text-4xl font-serif text-foreground/80 leading-relaxed relative z-10">
              Acompañar a mujeres a reorganizar su vida, su energía y sus hábitos, mientras reconectan con su identidad
              y construyen su nueva versión.
            </p>
          ...
          >
            ...
            <span className="text-sm tracking-[0.5em] uppercase text-secondary font-sans">Visión</span>
            <p className="mt-8 text-xl md:text-2xl lg:text-3xl font-serif text-background/80 leading-relaxed relative z-10">
              Crear una comunidad de mujeres conscientes, enfocadas y libres, que diseñan su vida desde la claridad y no
              desde el caos.
            </p>
        ...
        <div ref={valuesRef}>
          <span className="block text-md tracking-[0.5em] uppercase text-secondary mb-12 font-sans">
            Nuestros Valores
          </span>
          <div className="grid md:grid-cols-5 gap-px bg-border">
            {values.map((value) => (
              ...
              >
                ...
                <h4 className="text-xl md:text-2xl font-sans mb-3">{value.title}</h4>
                <p className="text-base font-serif text-foreground/50 leading-relaxed">{value.desc}</p>
              </div>
            ))}
          </div>
        </div>
