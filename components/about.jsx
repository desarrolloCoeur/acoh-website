      ...
      <div className="grid lg:grid-cols-2 min-h-screen">
        ...
        >
          ...
          >
            <p className="text-xl md:text-2xl lg:text-3xl font-serif italic text-background/90 max-w-md leading-relaxed">
              "Hubo un momento en el que me sentí invisible. Como si mis sueños
              se hicieran pequeños."
            </p>
          </div>
        </div>
        ...
        >
          <div className="max-w-xl">
            <span className="reveal-text block text-lg tracking-[0.5em] uppercase text-foreground mb-12 font-sans">
              Sobre Mí
            </span>

            <h2 className="reveal-text text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-sans font-light leading-[1.1] mb-12">
              No soy una marca que te diga{" "}
              <em className="font-serif">qué hacer.</em>
            </h2>

            <div className="space-y-8 text-foreground/60 font-serif text-lg md:text-xl leading-relaxed">
              <p className="reveal-text">
                Soy una mujer, mamá y emprendedora que después de sentirse
                cansada, confundida y sobreestimulada, decidió crear un sistema
                más humano para vivir, trabajar y maternar.
              </p>

              <p className="reveal-text">
                Entendí algo importante: mis sueños no se apagaron, se
                transformaron.
                <br />
                Hoy acompaño a mujeres que ya no encajan en la versión anterior
                de su vida y quieren construir una nueva.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-[90%] max-w-6xl mx-auto text-center">
          <p className="text-2xl md:text-3xl lg:text-4xl font-sans font-light text-primary-foreground leading-relaxed">
            ...
            <span className="font-serif italic">
              Creemos en hacerlo con intención.
            </span>
          </p>
        </div>
